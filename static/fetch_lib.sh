...
then
    if ! curl -sfL https://raw.githubusercontent.com/sjtuross/nextcloud-vm/master/lib.sh -o /var/scripts/lib.sh
    then
...
then
    curl -sfL https://raw.githubusercontent.com/sjtuross/nextcloud-vm/master/lib.sh -o /var/scripts/lib.sh
fi
